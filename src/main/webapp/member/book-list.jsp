...
<body>
    ...
    <div class="nav">
        <a href="<%= request.getContextPath() %>/BorrowHistoryServlet">My Borrow History</a> |
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <% if (book.getAvailable() && book.getCopies() > 0) { %>
                    <form action="<%= request.getContextPath() %>/BorrowServlet" method="post">
